...
const Morse: NextPage = () => {
    ...
    const buttonClicked = async (event: any) => {
        ...
        setBreeds(response.data.data as Breed[])
    }
    ...
    return (
        ...
        <div className="flex flex-col justify-evenly">
            ...
            <button onClick={buttonClicked}>Cliccami</button>
            <ul className="flex flex-col">
                {
                    breeds.map((b, i) => (
                        <li key={i} className="flex flex-row justify-evenly">
                            <label>Breed: {b.breed}</label>
                            <label>Country: {b.country}</label>
                            <label>Origin: {b.origin}</label>
                            <label>Coat: {b.coat}</label>
                            <label>Pattern: {b.pattern}</label>
                        </li>
                    ))
                }
            </ul>
