...
import NumberOfPlayers from "../components/game/NumberOfPlayers.vue";
import TurnOrder from "../components/game/TurnOrder.vue";
import TakeAShare from "../components/game/TakeAShare.vue";
import BuildRailroadTrack from "../components/game/BuildRailroadTrack.vue";
import RideTheRails from "../components/game/RideTheRails.vue";
...
<template>
    ...
    <div v-else>
        ...
        <div v-if="isBuildRailroadTrackPhase">
            <BuildRailroadTrack :player="playerInTurn" :five-dollars-cities="game.fiveDollarsCities"
                :chicago="game.chicago" :transcontinental="game.transcontinental" @railroad-built="railroadBuilt">
            </BuildRailroadTrack>
        </div>

        <div v-if="isRideTheRailsPhase">
            <RideTheRails :player-turn="game.playerTurn" :players="game.players" @rails-ridden="railsRidden">
            </RideTheRails>
        </div>
    </div>
</template>